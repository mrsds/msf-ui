...
var routes = [
    ...
    [
        { x: -75.9375, y: 35.460669951495305 },
        { x: 146.25, y: -43.06888777416961 },
        { name: "crosses dateline 1" }
    ],
    [
        { x: 145.54687500000003, y: 48.45835188280866 },
        { x: -112.5, y: -37.71859032558814 },
        { name: "crosses dateline 2" }
    ],
    [
        { x: -74.564208984375, y: -0.17578097424708533 },
        { x: 137.779541015625, y: -22.75592068148639 },
        { name: "south 1" }
    ],
    [
        { x: -66.829833984375, y: -18.81271785640776 },
        { x: 118.795166015625, y: -20.797201434306984 },
        { name: "south 2" }
    ]
];
// trouble: needs work
...
var arcs = [
        ...
        geometries: [
            {
                coords: [
                    ...
                    [-97.72808611752785, 45.75368189927002],
        ...
        geometries: [
            {
                coords: [
                    [-122, 48.00000000000001],
                    [-64.16590091973099, 67.47624207149578],
                    [0, 51]
                ],
                length: 3
            }
    ...
    },
    {
        ...
        geometries: [
            {
                coords: [
                    [-75.9375, 35.46066995149531],
                    [-136.82303405489677, -10.367409282634164],
                    [146.25, -43.06888777416961]
                ],
                length: 3
            }
        ]
    },
    {
        ...
        geometries: [
            {
                coords: [
                    [145.54687500000003, 48.45835188280866],
                    [-157.28484118689477, 8.44205355944752],
                    [-112.5, -37.71859032558814]
                ],
                length: 3
            }
        ]
    },
    {
        ...
        geometries: [
            {
                coords: [
                    [-74.564208984375, -0.17578097424708533],
                    [-140.44327137076033, -35.80108605508993],
                    [137.779541015625, -22.755920681486387]
                ],
                length: 3
            }
        ]
    },
    {
        ...
        geometries: [
            {
                coords: [
                    [-66.829833984375, -18.812717856407765],
                    [-146.78177837397814, -82.1795027896656],
                    [118.795166015625, -20.79720143430698]
                ],
                length: 3
            }
        ]
